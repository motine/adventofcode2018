# mix -S mix
# iex> recompile(); Day4.solve_part1
#
# or:
# mix test
defmodule Sleep do
...
defmodule Day4 do
  ...
  def solve_part1 do
    ...
    IO.puts("Sleepiest guard #{sleepiest_id} slept #{sleepiest_duration} minutes.")
    ...
    IO.puts("Sleepiest guard slept #{sleeps_for_minute} times on minute #{sleepiest_minute}.")

    IO.puts("The result is #{sleepiest_id * sleepiest_minute}")    
  end
end
